...
const translations = {
  ...
  "export.title": { en: "Export workouts", es: "Exportar entrenos" },
  "export.hint": { en: "Download CSV to analyze with AI", es: "Descargá el CSV para analizar con IA" },
  "export.sheetDesc": { en: "Export your workouts to analyze with AI", es: "Exportá tus entrenos para analizar con IA" },
  "export.exporting": { en: "Exporting...", es: "Exportando..." },
  "export.copy": { en: "Copy", es: "Copiar" },
  "export.download": { en: "Download CSV", es: "Descargar CSV" },
  "export.copied": { en: "Copied", es: "Copiado" },
  "export.downloaded": { en: "Downloaded", es: "Descargado" },
  "export.empty": { en: "No workouts to export yet", es: "Todavía no hay entrenos para exportar" },
